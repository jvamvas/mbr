# Adapted from https://github.com/MicrosoftTranslator/GEMBA/blob/9d6a79b3812dc1c1ed0134e74ca19d0caa324f13/gemba/cache.py
...
class Cache:
    def __init__(self, cache_file):
        self.folder = Path(__file__).parent / "cache"
        self.folder.mkdir(exist_ok=True)
        self.cache_filename = cache_file
        self.cache_file = self.folder / self.cache_filename
        self.last_reload = 0
